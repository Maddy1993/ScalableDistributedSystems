        ...
        switch (option) {
            case 1:
                try {
                    ...
                    if (!value.equalsIgnoreCase(MessageType.NONE.name())) {
            ...
            case 2:
                ...
                try {
                    serverResponse = server.setKeyValue(key, value, MessageType.COORDINATOR);

                    if (serverResponse == MessageType.ABORT) {
            ...
            case 3:
                try {
                    ...
                    serverResponse = server.removeKey(key, MessageType.COORDINATOR);

                    if (serverResponse == MessageType.COMMIT) {
                        System.out.println("Key: " + key + " successfully removed");
                    } else if (serverResponse == MessageType.ABORT){
