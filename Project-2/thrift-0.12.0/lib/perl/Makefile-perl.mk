...
VERSION_SYM = v0_12_0_0
DEFINE_VERSION = -D$(VERSION_MACRO)=\"$(VERSION)\"
XS_VERSION = v0.12.0_0
...
PM_TO_BLIB = lib/Thrift/MultiplexedProcessor.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: v0.12.0_0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "v0.12.0_0"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
